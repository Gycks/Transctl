...
from src.utils.utils_suit import normalize_text
...
class TranslatorBase(BaseModel, ABC):
    ...
    @abstractmethod
    def protect_text(self, text: str, patterns: list[re.Pattern]) -> str:
        """
        ...
        Args:
            ...
            patterns (list[re.Pattern]): A list of compiled regular expression patterns to match-text that should be protected.
